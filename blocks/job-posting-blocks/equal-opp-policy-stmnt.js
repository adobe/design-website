...
//  */
// export async function getJobsFragment(relPath = REL_PATH) {
//     try {
//         // const stmnt = await fetchFragment(`jobs/${relPath}`);

//         return  await fetchFragment(`jobs/${relPath}`);
//     } catch(err) {
//          console.log(`Unable to fetch fragment: ${relPath}`);
//          console.error(err);
//          return null;
//     }
// }